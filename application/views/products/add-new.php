            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group <?php echo empty(form_error('title')) ? null : 'has-feedback has-error'?>">
                  ...
                  <input type="text" class="form-control"  placeholder="Enter  ..." name="title" value="<?php echo set_value('title');?>">
                ...
                <div class="form-group <?php echo empty(form_error('publisher')) ? null : 'has-feedback has-error'?>">
                  ...
                  <input type="text" class="form-control"  placeholder="Enter ..." name="publisher" value="<?php echo set_value('publisher');?>">
                ...
                <div class="form-group <?php echo empty(form_error('author')) ? null : 'has-feedback has-error'?>">
                  ...
                  <input type="text" class="form-control"  placeholder="Enter ..." name="author" value="<?php echo set_value('author');?>">
                ...
                <div class="form-group <?php echo empty(form_error('category')) ? null : 'has-feedback has-error'?>">
                  ...
                  <select class="form-control" name="category">
                    ...
                    <?php foreach ($category as $cat):?>
                      <option value="<?php echo $cat->id;?>" <?php echo set_select('category', set_value('category'));?>><?php echo $cat->name;?></option>
                    <?php endforeach;;?>
                  </select>
                ...
                <div class="form-group <?php echo empty(form_error('price')) ? null : 'has-feedback has-error'?>">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control"  placeholder="Enter ..." name="price" value="<?php echo set_value('price');?>">
                  </div>
                ...
                <div class="form-group <?php echo empty(form_error('synopsis')) ? null : 'has-feedback has-error'?>">
                  ...
                  <textarea cols="30" rows="5" class="form-control" name="synopsis"><?php echo set_value('synopsis');?></textarea>
                ...
                <div class="form-group <?php echo empty(form_error('details')) ? null : 'has-feedback has-error'?>">
                  ...
                  <textarea cols="30" rows="5" class="form-control" name="details"><?php echo set_value('details');?></textarea>
                  <?php echo form_error('details', '<span class="help-block">', '</span>');?>
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer clearfix">
                <button type="submit" class="btn btn-info pull-right" name="add" value="add">Add</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
